...
import Alita.modules.sql.chatbot_sql as ly
import requests
...
async def qt(event):
 ...
 try:
      async with tbot.action(event.chat_id, 'typing'):
           ...
           await event.reply('Error Report @AlitaBotSupport')
...
__help__ = """
**For text assistant**
 - /Alita <question>: Ask Alita any question and it will give accurate reply. For eg: `/Alita where is Taj Mahal`, `/Alita what is the age of Virat Kohli` etc..
**For voice assistant**
 - /Alita: Reply to a voice query and get the results in voice output (ENGLISH ONLY)
 
**Terminal Assistant**
 - /howdoi <question>: Get all coding related answers from Alita. Syntax: `/howdoi print hello world in python`
