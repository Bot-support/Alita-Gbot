#By #Devil (github.com/ITZ-DEVIL-OP ; t.me/DANlSH_OP)
#By RoseLoverX Telegram
#Don't Forget to give credit and make your source public.

from Alita import tbot, OWNER_ID, DEV_USERS
from Alita import MONGO_DB_URI, BOT_ID, GBAN_LOGS
from pymongo import MongoClient
from Alita.function import is_admin, sudo
from telethon import events
from Alita.events import register
from telethon.tl.functions.users import GetFullUserRequest

from Alita.modules.sql.chats_sql import get_all_chat_id
...
async def gban(event):
 ...
 k = await event.reply("Successfully Fucked This User 🤪")
