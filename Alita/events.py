...
from Alita import CMD_LIST, LOAD_PLUG, tbot
import glob
import sys
from Alita import ubot
from pymongo import MongoClient
from Alita import MONGO_DB_URI
from Alita.modules.sql.checkuser_sql import add_usersid_in_db, already_added, get_all_users
...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        path = Path(f"Alita/modules/{shortname}.py")
        name = "Alita.modules.{}".format(shortname)
        ...
        mod.Alita_Gbot = Alita_Gbot
        mod.tbot = tbot
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["Alita.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "Alita/modules/*.py"
